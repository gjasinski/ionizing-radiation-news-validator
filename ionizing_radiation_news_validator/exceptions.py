...
class NLPNewsCheckerNotValid(Exception):
    def __init__(self,
                 value="Given instance of NLPNewsChecker is not valid, "
                       "please check if you found date and countries in "
                       "article"):
        self.value = value
...
class CityNotFound(Exception):
    def __init__(self,
                 value="I can't find this city. Please search only major "
